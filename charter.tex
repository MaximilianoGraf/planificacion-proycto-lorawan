...
Por medio de la presente se acuerda con el \authorname\hspace{1px} que su Trabajo Final de la \degreename\hspace{1px} se titulará ``\ttitle'', consistirá esencialmente en la construcción de un prototipo de nodo LoRaWAN que implementará un software para administrar diversos sensores. Tendrá un presupuesto preliminar estimado de 614 hs de trabajo y \textcolor{red}{\$XXX}, con fecha de inicio \fechaInicioName\hspace{1px} y fecha de presentación pública \fechaFinalName.
...
\item Software del nodo
	...
	\item RN-003 Debe enviar los datos recolectados de los sensores mediante un modem LoRa hacia un gateway.
...
\begin{itemize}
\item Como usuario quiero utilizar diferentes sensores en simultáneo. 5
\item Como usuario quiero visualizar información de los sensores conectados al nodo de manera remota. 2
\item Como usuario quiero conocer el estado del nodo de manera remota.        1
\item Como desarrollador quiero cambiar facilmente la plataforma de hardware. 8
\end{itemize}
...
\item Introducción (134 hs)
	...
	\item Analizar documentación de las plataformas de HW a utilizar (30 hs)
...
\item SW nodo (120 hs)
	...
	\item Testing (40 hs)
	\end{enumerate}
\item Integración (68 hs)
	\begin{enumerate}
	\item Configuración gateway (8 hs)
	\item Implementación aplicación de usuario(30 hs)
	\item Testing y pruebas end to end (30 hs)
	\end{enumerate}
\item Gestión del proyecto (134 hs)
	\begin{enumerate}
